...
export class InstallmentsController {
    static async create(req, res, next) {
        try {
            ...
            const { entity_id, description, amount, installment_count, start_date, category, category_id } = req.body;
    ...
    static async cancel(req, res, next) {
        try {
            ...
            await Promise.all(purchase.transactions.map(transaction => prisma.transactions.update({
