...
export type BudgetsAvgAggregateOutputType = {
    id: number | null;
    user_id: number | null;
    amount_limit: runtime.Decimal | null;
};
...
type GetBudgetsGroupByPayload<T extends budgetsGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<BudgetsGroupByOutputType, T['by']> & {
...
export type budgetsWhereInput = {
    ...
    user_id?: Prisma.IntFilter<"budgets"> | number;
    category?: Prisma.StringFilter<"budgets"> | string;
    amount_limit?: Prisma.DecimalFilter<"budgets"> | runtime.Decimal | runtime.DecimalJsLike | number | string;
    month_ref?: Prisma.StringNullableFilter<"budgets"> | string | null;
...
export type budgetsOrderByWithRelationInput = {
    ...
    amount_limit?: Prisma.SortOrder;
    month_ref?: Prisma.SortOrderInput | Prisma.SortOrder;
...
export type budgetsWhereUniqueInput = Prisma.AtLeast<{
    id?: number;
    user_id_category?: Prisma.budgetsUser_idCategoryCompoundUniqueInput;
    AND?: Prisma.budgetsWhereInput | Prisma.budgetsWhereInput[];
    OR?: Prisma.budgetsWhereInput[];
    NOT?: Prisma.budgetsWhereInput | Prisma.budgetsWhereInput[];
    user_id?: Prisma.IntFilter<"budgets"> | number;
...
export type budgetsScalarWhereWithAggregatesInput = {
    ...
    user_id?: Prisma.IntWithAggregatesFilter<"budgets"> | number;
    category?: Prisma.StringWithAggregatesFilter<"budgets"> | string;
    amount_limit?: Prisma.DecimalWithAggregatesFilter<"budgets"> | runtime.Decimal | runtime.DecimalJsLike | number | string;
    month_ref?: Prisma.StringNullableWithAggregatesFilter<"budgets"> | string | null;
    created_at?: Prisma.DateTimeNullableWithAggregatesFilter<"budgets"> | Date | string | null;
};
export type budgetsCreateInput = {
    category: string;
    amount_limit: runtime.Decimal | runtime.DecimalJsLike | number | string;
    month_ref?: string | null;
...
export type budgetsUpdateInput = {
    ...
    amount_limit?: Prisma.DecimalFieldUpdateOperationsInput | runtime.Decimal | runtime.DecimalJsLike | number | string;
    month_ref?: Prisma.NullableStringFieldUpdateOperationsInput | string | null;
...
export type budgetsUser_idCategoryCompoundUniqueInput = {
    user_id: number;
    category: string;
};
...
export type budgetsOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "user_id" | "category" | "amount_limit" | "month_ref" | "created_at", ExtArgs["result"]["budgets"]>;
...
export interface budgetsFieldRefs {
    ...
    readonly user_id: Prisma.FieldRef<"budgets", 'Int'>;
    readonly category: Prisma.FieldRef<"budgets", 'String'>;
    readonly amount_limit: Prisma.FieldRef<"budgets", 'Decimal'>;
    readonly month_ref: Prisma.FieldRef<"budgets", 'String'>;
