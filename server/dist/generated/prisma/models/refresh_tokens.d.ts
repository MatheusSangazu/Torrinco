...
type GetRefresh_tokensGroupByPayload<T extends refresh_tokensGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<Refresh_tokensGroupByOutputType, T['by']> & {
...
export type refresh_tokensOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "token" | "user_id" | "expires_at" | "created_at" | "revoked_at", ExtArgs["result"]["refresh_tokens"]>;
