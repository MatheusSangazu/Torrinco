    ...
    try {
      ...
      res.json({
        ...
        bill: {
          ...
          paidAmount: details.bill.paid_amount,
          remainingAmount: details.bill.remaining_amount,
          payments: details.bill.payments,
    ...
    try {
      ...
      res.json({
        ...
        bill: {
          ...
          paidAmount: details?.bill.paid_amount ?? 0,
          remainingAmount: details?.bill.remaining_amount ?? computed.total,
          payments: details?.bill.payments ?? [],
